...
let dropdowns = document.querySelectorAll("#dropdown select") as NodeListOf<HTMLSelectElement>;
let fromcurr = document.querySelector(".from select") as HTMLSelectElement;
let tocurr = document.querySelector(".to select") as HTMLSelectElement;
  ...
  .then((data) => {
    ...
    dropdowns.forEach((select) => {
      for (let code in countryList) {
        let newOptions: HTMLOptionElement = document.createElement("option");
